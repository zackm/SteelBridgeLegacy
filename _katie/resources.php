...
<?php require('wordpress/wp-blog-header.php');?>
	...
	<div class="nav_bar">
		<div class="table">
			<ul id="menu">
                ...
                <li class="resources"><a href="resources.php" class="nav_links" id="current">Resources</a></li>
    ...
    <div class="main">
		<div id="main_title">Resources</div>
		<div id="main_tagline">Check out some useful links here.</div>
         
	    <div class="cont">
        <?php
		$posttitle = '2011-2012 Steel Bridge Competition';
