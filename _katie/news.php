...
<?php require('wordpress/wp-blog-header.php');?>
	...
	<div class="nav_bar">
		<div class="table">
			<ul id="menu">
                ...
                <li class="news"><a href="news.php" class="nav_links" id="current">News</a></li>
    ...
    <div class="main">
		<div id="main_title">News</div>
		<div id="main_tagline">Read all about Cal Steel in the news.</div> 

    	<?php query_posts('category_name=news'); ?>
        <?php while (have_posts()) : the_post(); ?>
    	<div class="cont">
        <div class="sub_title"><?php the_title();?></div>
        <div class="sub_cont"><?php the_time('F jS, Y') ?></div>
        <div class="sub_cont"><?php the_content()?></div>
        </div>
        <?php endwhile;?>
