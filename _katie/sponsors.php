...
<div class="wrapper">
	...
	<div class="nav_bar">
		<div class="table">
			<ul id="menu">
                ...
                <li class="sponsors"><a href="sponsors.php" class="nav_links" id="current">Sponsors</a></li>
    ...
    <div class="main">
		<div id="main_title">Sponsors</div>
		<div id="main_tagline">Cal Steel Bridge would not be possible without the support of our sponsors.</div>
        
        <div class="table">
        <div class="sponsors_cont">
		<a href="http://www.csiberkeley.com/sap2000" alt="SAP2000" target="_new"><img src="images/sap.png" alt="SAP2000"/></a>
        <a href="http://www.solidworks.com/" alt="SolidWorks" target="_new"><img src="images/solidworks.png" alt="SolidWorks"/></a>
        <a href="http://www.boeing.com/" alt="Boeing" target="_new"><img src="images/boeing.png" alt"Boeing"/></a>
		</div>
        </div>
        
		<div class="table">
        <div class="sponsors_cont">
        <a href="http://www.aircraftspruce.com/" target="_new"><img src="images/spruce.png" alt="Spruce"/></a>
        <a href="http://www.albanysteel.com/" target="_new"><img src="images/albany.png" alt="Albany"/></a>
		<a href="http://www.atlaswelding.com/" target="_new"><img src="images/atlas.png" alt"Atlas"/></a>
        </div>
        </div>
        
		<div class="table">
        <div class="sponsors_cont">
        <a href="http://www.emjmetals.com/index.htm" target="_new"><img src="images/emj.png" alt"EMJ"/></a>
        <a href="http://www1.mscdirect.com/cgi/nnsrhm" target="_new"><img src="images/msc.png" alt"MSC"/></a>
        </div>
        </div>
        
        <div class="sub_cont" id="sponsors">Interested in sponsoring or just want to know more?  Send an email to <div class="email">calsteel(at)lists.berkeley.edu</div></div>
	</div>
